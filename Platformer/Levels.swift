...
struct Levels {
    var data: [(blocks: [String], script: (_ gameScene: GameScene) -> ())] = [
        ...
        (blocks: [
            ...
            "X@ XBX!!!!!!!!X!!!XXXXXXXXXXXXXXXX>>>>>>>>>>>>>>>>>><<<<<<<<<<<<< X                     X",
            "XVVXOX        X                  X             R                  X                     X",
            "XVVXOX        X   XFFFFFFFFFFFFFFX O O O       R      R           X                     X",
            "XVVXOX    X   X   X              X        R    R      R           X                     X",
            "XOOXOX    X   X   X              X        R           R           X                     X",
            "XOOXOX    X   X   X              XFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFXXXXXXXXXXXXXXXXXXXXXXX",
            "XVOXOXRRRRXRRRXRRRXFFFFFFFFFFFFFFX                    R           X                      ",
            "XOOXRX    X       X              X  RRR        !!!!!!!!!!!!!!!!!!!X                      ",
            "XOOXBX    X       X              X                                X                      ",
            "XOOX      X       X              X  O O                        OOOX                      ",
